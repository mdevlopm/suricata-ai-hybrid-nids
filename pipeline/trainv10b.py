...
# -*- coding: utf-8 -*-
"""
Pipeline Train V10b: Multi-Source Supervised IDS Training with Cleaned CTU-13 Botnet Data
Removes benign-like DNS / Ads / Background traffic from Botnet class.
...
MODEL_OUT = BASE_DIR / "models/ids_model_v10b_final.pkl"
...
def main():
    print("=" * 80)
    print("IDS PIPELINE V10b: SUPERVISED TRAINING WITH CLEANED CTU-13 BOTNET DATA")
    ...
    # B. CTU-13 Clean Malicious Botnet Flows (Filtered out DNS/Ads)
    ...
    print("\nTraining XGBoost V10b Multi-Class Classifier...")
    params = {
    ...
    bundle = {
        ...
        'coral_adapter': None,
        'threshold': 0.84,
        'version': 'v10b_cleaned_ctu13',
        'timestamp': datetime.now().isoformat()
    }
    MODEL_OUT.parent.mkdir(parents=True, exist_ok=True)
    with open(MODEL_OUT, 'wb') as f:
        pickle.dump(bundle, f, protocol=pickle.HIGHEST_PROTOCOL)
    print(f"Saved V10b Model to: {MODEL_OUT}")

    # 5. Dual-Metric Operating Curve Evaluation (0.50 - 0.99)
    print("\n" + "=" * 105)
    print("OPERATING CURVE EVALUATION (0.50 - 0.99) FOR V10b MODEL")
    print("=" * 105)
    ...
    with open('/tmp/v10b_operating_curve.json', 'w') as f:
