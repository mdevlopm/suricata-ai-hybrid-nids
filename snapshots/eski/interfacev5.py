...
# -*- coding: utf-8 -*-
"""
inference_v4_optimized.py – Optimize eğitim v4 ile uyumlu çıkarım motoru
"""
...
def extract_features(event: dict):
    """Optimize edilmiş özellik çıkarımı: aşırı hız değerleri önlendi."""
    ...
    meta = {
        ...
        "total_bytes": int(tb),
        "byte_rate": round(tb / sd_clipped, 1),   # aynı sınırlama
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="IDS AI Çıkarım Motoru v4 (Optimize)")
