...
# -*- coding: utf-8 -*-
"""
inference_v2.py - Eve.json IDS Çıkarımı (egitim_v2.py ile uyumlu)
====================================================================
Gerçek zamanlı veya batch modda Suricata eve.json akışlarını sınıflandırır.
Eğitim koduyla birebir aynı feature extraction kullanır.
...
Kullanım:
  ...
  Batch:
    python3 inference_v2.py --eve test.eve.json --batch

Model yolu varsayılan olarak eğitim çıktısının kaydedildiği dizindir.
"""
