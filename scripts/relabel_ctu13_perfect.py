...
def main():
    ...
    for sc_dir in sorted(ctu_dir.glob("scenario_*")):
        ...
        l_files = (
            list(sc_dir.glob("*.binetflow"))
            + list(sc_dir.glob("*.biargus"))
            + list(sc_dir.glob("**/*.binetflow"))
            + list(sc_dir.glob("**/*.biargus"))
        )
